        ...
        ZStack {
            ...
            VStack {
                ...
                HStack(spacing: 20) {
                    ...
                    WeatherDayView(dayOfWeek: "WED", imageName: "wind.snow", temperature: 52)
                    WeatherDayView(dayOfWeek: "THU", imageName: "sun.max.fill", temperature: 70)
                    WeatherDayView(dayOfWeek: "FRI", imageName: "snow", temperature: 77)
                }
